...
class CriticalCssTest extends FunctionalTestCase
{
    ...
    /**
     * @var \RKW\RkwBasics\ContentProcessing\CriticalCss
     */
    private $subject;
    ...
    public function getCssFilesToRemoveReturnsConfiguredFiles()
    {
        ...
        self::assertEquals(
            'EXT:rkw_basics/Tests/Integration/ContentProcessing/CriticalCssTest/Fixtures/Frontend/Files/Global/removeTwo.css',
            $result[20]
        );
