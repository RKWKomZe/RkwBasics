...
class MarkerReducerTest extends FunctionalTestCase
{
    ...
    public function implodeUsingPersistedObjectsReturnsCompletelyReducedArray()
    {
        ...
        $expected = [
            ...
            'test2' => 'RKW_BASICS_NAMESPACES RKW\RkwBasics\Domain\Model\Pages:2',
            'test3' => 'RKW_BASICS_NAMESPACES RKW\RkwBasics\Domain\Model\Pages:3',
            'test4' => 'RKW_BASICS_NAMESPACES_ARRAY RKW\RkwBasics\Domain\Model\Pages:2,RKW\RkwBasics\Domain\Model\Pages:3',
        ];
    ...
    public function explodeUsingNonExistingObjectsReturnsReducedObjectArray()
    {
        ...
        $marker = [
            'test1' => 'RKW_BASICS_NAMESPACES RKW\RkwBasics\Domain\Model\Pages:1',
            'test2' => 'RKW_BASICS_NAMESPACES RKW\RkwBasics\Domain\Model\Pages:2',
            'test3' => 'RKW_BASICS_NAMESPACES RKW\RkwBasics\Domain\Model\Pages:9999',
            'test4' => 'RKW_BASICS_NAMESPACES_ARRAY RKW\RkwBasics\Domain\Model\Pages:3,RKW\RkwBasics\Domain\Model\MediaSources:9999',
        ];
    ...
    public function explodeUsingOnlyNonExistingObjectsInObjectStorageReturnsEmptyObjectStorage()
    {
        ...
        $marker = [
            ...
            'test2' => 'RKW_BASICS_NAMESPACES RKW\RkwBasics\Domain\Model\Pages:2',
            'test3' => 'RKW_BASICS_NAMESPACES RKW\RkwBasics\Domain\Model\Pages:9999',
            'test4' => 'RKW_BASICS_NAMESPACES_ARRAY RKW\RkwBasics\Domain\Model\Pages:8888,RKW\RkwBasics\Domain\Model\MediaSources:9999',
        ];
    ...
    public function explodeLeavesItemsWithoutKeywordsUntouched()
    {
        ...
        $expected = [
            ...
            'test4' => 'RKW_TESTER_NAMESPACES_ARRAY RKW\RkwBasics\Domain\Model\Pages:8888,RKW\RkwBasics\Domain\Model\MediaSources:9999',
