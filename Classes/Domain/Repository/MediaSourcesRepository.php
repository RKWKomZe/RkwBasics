...
class MediaSourcesRepository extends AbstractRepository
{
    ...
    public function findAllWithPublisher($pagesUidList = array(), $respectFields = true)
    {
        ...
        $mediaSourcesTable = 'tx_rkwbasics_domain_model_mediasources';
        ...
        $statement = '
            ...
            RIGHT JOIN (' . $mediaSourcesTable . ')
                ON (
                    ' . $mediaSourcesTable . '.uid = ' . $fileMetaTable . '.tx_rkwbasics_source
            ...
            ORDER BY
                ...
                ' . $fileMetaTable . '.tx_rkwbasics_publisher ' . \TYPO3\CMS\Extbase\Persistence\QueryInterface::ORDER_ASCENDING . '
        ';
    ...
    public function findByFileUid($uid)
    {
        ...
        $query->statement('
            ...
            WHERE
                ...
                AND ' . $mediaSourcesTable . '.uid = ' . $fileMetaTable . '.tx_rkwbasics_source
        ');
