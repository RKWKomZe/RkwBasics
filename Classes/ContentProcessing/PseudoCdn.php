...
class PseudoCdn
{
    ...
    public function getSettings()
    {
        ...
        if (
            (isset($GLOBALS['TSFE']->config['config']['tx_rkwbasics_cdn.']))
            && (is_array($GLOBALS['TSFE']->config['config']['tx_rkwbasics_cdn.']))
        ){
            $settings = array_merge($settings, $GLOBALS['TSFE']->config['config']['tx_rkwbasics_cdn.']);
