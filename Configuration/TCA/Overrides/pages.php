...
$tempColumnsPages = array(
	...
	'tx_rkwbasics_fe_layout_next_level' => array(
		'exclude' => 1,
		...
		'config' => array(
			...
			'items' => array (
				array('LLL:EXT:rkw_basics/Resources/Private/Language/locallang_db.xlf:tx_rkwbasics_domain_model_pages.tx_rkwbasics_fe_layout_next_level.I.0', '0'),
				array('LLL:EXT:rkw_basics/Resources/Private/Language/locallang_db.xlf:tx_rkwbasics_domain_model_pages.tx_rkwbasics_fe_layout_next_level.I.1', '1'),
				array('LLL:EXT:rkw_basics/Resources/Private/Language/locallang_db.xlf:tx_rkwbasics_domain_model_pages.tx_rkwbasics_fe_layout_next_level.I.2', '2'),
				array('LLL:EXT:rkw_basics/Resources/Private/Language/locallang_db.xlf:tx_rkwbasics_domain_model_pages.tx_rkwbasics_fe_layout_next_level.I.3', '3'),
			),
			'size' => 1,
			'maxitems' => 1,
		),
	...
	'tx_rkwbasics_css_class' => array(
        ...
        'config' => array(
            ...
            'renderType' => 'selectSingle',
            'items' => array (
                array('LLL:EXT:rkw_basics/Resources/Private/Language/locallang_db.xlf:tx_rkwbasics_domain_model_pages.tx_rkwbasics_css_class.I.0', '0'),
                array('LLL:EXT:rkw_basics/Resources/Private/Language/locallang_db.xlf:tx_rkwbasics_domain_model_pages.tx_rkwbasics_css_class.I.1', '1'),
                array('LLL:EXT:rkw_basics/Resources/Private/Language/locallang_db.xlf:tx_rkwbasics_domain_model_pages.tx_rkwbasics_css_class.I.2', '2'),
                array('LLL:EXT:rkw_basics/Resources/Private/Language/locallang_db.xlf:tx_rkwbasics_domain_model_pages.tx_rkwbasics_css_class.I.3', '3'),
            ),
            'size' => 1,
            'maxitems' => 1,
        ),
	),
    'tx_rkwbasics_old_domain' => array (
        'exclude' => 1,
    ...
    'tx_rkwbasics_use_as_canonical' => array (
        'exclude' => 1,
    ...
    'tx_rkwbasics_teaser_image' => array(
        'exclude' => 0,
    ...
    'tx_rkwbasics_article_image' => array(
        'exclude' => 0,
    ...
    'tx_rkwbasics_article_video' => array (
        'exclude' => 0,
    ...
    'tx_rkwbasics_proxy_caching' => array(
        'exclude' => 1,
        ...
        'config' => array(
            ...
            'maxitems' => 1,
            'items' => array(
                array('LLL:EXT:rkw_basics/Resources/Private/Language/locallang_db.xlf:tx_rkwbasics_domain_model_pages.tx_rkwbasics_proxy_caching.I.inherit', 0),
                array('LLL:EXT:rkw_basics/Resources/Private/Language/locallang_db.xlf:tx_rkwbasics_domain_model_pages.tx_rkwbasics_proxy_caching.I.enabled', 1),
                array('LLL:EXT:rkw_basics/Resources/Private/Language/locallang_db.xlf:tx_rkwbasics_domain_model_pages.tx_rkwbasics_proxy_caching.I.disabled', 2)
...
$tempColumnsPagesMulti = array(

    'tx_rkwbasics_alternative_title' => array (
        'exclude' => 0,
    ...
    'tx_rkwbasics_information' => array(
        'exclude' => 0,
...
//===========================================================================
$GLOBALS['TCA']['pages']['types'][(string)\TYPO3\CMS\Frontend\Page\PageRepository::DOKTYPE_SYSFOLDER] = array(
...
//$GLOBALS['TCA']['pages_language_overlay']['palettes']['abstract']['showitem'] = '';
// str_replace('abstract;LLL:EXT:frontend/Resources/Private/Language/locallang_tca.xlf:pages.abstract_formlabel', '', $GLOBALS['TCA']['pages_language_overlay']['palettes']['abstract']['showitem']);
